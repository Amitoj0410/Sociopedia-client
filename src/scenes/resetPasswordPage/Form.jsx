...
const Form = () => {
  ...
  const resetPassword = async (values, onSubmitProps) => {
    const resetPasswordResponse = await fetch(
      //   "https://fuzzy-cyan-harp-seal.cyclic.app/auth/login",
      "https://fuzzy-cyan-harp-seal.cyclic.app/auth/reset_password/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY1Y2RiODRmNzljOTZkYmNlNDhjZTBkOCIsImlhdCI6MTcwNzk4NTU1NCwiZXhwIjoxNzA3OTg5MTU0fQ.cl5laGS5Af_eZ_tymUVTecdrtOUdx04AxIoomrs_yDc",
      {
        method: "POST",
        headers: { "Content-type": "application/json" },
        body: JSON.stringify(values),
